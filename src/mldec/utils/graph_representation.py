'''Notice - code below this line is copied from https://github.com/LangeMoritz/GNN_decoder/blob/main/src/graph_representation.py 
...
def get_node_feature_matrix(defects, defect_indices_triple, num_node_features = None):
    ...
    if num_node_features is None:
        num_node_features = 5 # By default, use 5 node features
